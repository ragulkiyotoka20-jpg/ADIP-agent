...
global.document = {
  ...
  querySelectorAll: (selector) => [mockElement(), mockElement()],
...
try {
  console.log("Running frame checks from 0 to 1950...");
  for (let f = 0; f <= 1950; f++) {
    updateShowcase(f);
  }
  console.log("Success! Checked all 1951 frames without errors.");
} catch (e) {
  console.error("CRASH at frame " + currentFrame + ":", e.message);
